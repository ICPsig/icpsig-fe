...
import dfinityLogo from 'src/assets/parachains-icons/dfinity-logo.png';
import ckBTCLogo from 'src/assets/parachains-icons/ckBTC-logo.jpeg';
import dragginZLogo from 'src/assets/parachains-icons/dragginz-logo.jpeg';
import wrappedICPLogo from 'src/assets/parachains-icons/wrapped-icp-logo.jpeg';
import chatLogo from 'src/assets/parachains-icons/chat-logo.png';
import kinicLogo from 'src/assets/parachains-icons/kinic-logo.png';
import hotNotLogo from 'src/assets/parachains-icons/hot-not-logo.png';
// import ethereumLogo from 'src/assets/eth.png';
// import polygonLogo from 'src/assets/polygon.png';
import { ChainPropType, TokenProperties } from 'src/types';
