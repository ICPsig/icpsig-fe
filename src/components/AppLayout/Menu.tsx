...
import icpLogo from 'src/assets/icp-logo.png';
import icpText from 'src/assets/icp-text.tif.png';
	...
	const AddMultisigModal: FC = () => {
		return (
			<Modal
				...
				title={<h3 className='text-white font-medium text-lg'>Create Multisig</h3>}
