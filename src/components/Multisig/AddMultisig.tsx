...
import { CreateMultisigIcon, OutlineCloseIcon } from 'src/ui-components/CustomIcons';
				...
				<div className='h-full flex flex-col justify-center'>
					<div className='p-5'>
						...
						<div className='flex justify-center mt-5 w-full px-10'>
							<div className={`flex flex-col ${homepage ? 'w-[50%]' : 'w-full'} w-[50%] items-left justify-between bg-bg-secondary rounded-lg p-5 mx-5`}>
								<div className='mb-5'>
